...
Namespace ApiExamples
	...
	Public Class CustomBarcodeGenerator
		...
		''' <returns></returns>
		Public Function GetBarcodeImage(ByVal parameters As BarcodeParameters) As Image
		...
		''' <param name="parameters"></param>
		''' <returns></returns>
		Public Function GetOldBarcodeImage(ByVal parameters As BarcodeParameters) As Image
